...
Resultado atual: `pnpm test` passa com **137 testes** (incl. encryption, dailySpend, organizations, cloud-provider-credentials, adapter-engine (SyncAccountUseCase + AwsProvider, VercelProvider, GcpProvider), analytics, **notifications** (SlackProvider, DiscordProvider, SendAnomalyAlertUseCase, TestWebhookConnectionUseCase, TriggerAnomalyAlertAfterSyncUseCase)).
